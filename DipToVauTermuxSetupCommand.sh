...
echo "Wait brother..Because all basic packages is being downloaded...Wait here kindly for some time please."
...
figlet -f slant '🔰DipTo Vau���� |lolcat
echo
echo
echo 
figlet -f slant 'Welcome BRO to your TERMUX❤️' |lolcat
echo
echo
echo
